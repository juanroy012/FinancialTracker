...
from app.models.transaction import get_all_transactions, get_transaction_by_id,create_transaction, delete_transaction, update_transaction
...
def transaction_details(
    ...
    transaction = get_transaction_by_id(transaction_id, conn)
